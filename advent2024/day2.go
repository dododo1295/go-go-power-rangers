...
func day2_1(input string) {
	...
	fmt.Println("Had the general idea but needed help actualizing everything Day 2 Part 1", output)
}
...
func day2_2(input string) {
	...
	fmt.Println("This one needed every ounce of help Day 2 Part 2: ", output)
}
